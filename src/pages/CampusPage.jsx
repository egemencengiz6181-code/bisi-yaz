...
const pageContent = {
  tr: {
    ...
    scheduleRows: [
      ...
      { type: 'fixed',       time: '12:15–13:00', activity: 'Öğle Yemeği & Serbest Oyun',        emoji: '🍽️' },
    ...
    weeklySub: 'Program, 8 hafta boyunca farklı temalarla planlanmış olup öğrencilerimizin her hafta farklı bir gelişim alanını deneyimlemeleri hedeflenmektedir.',
  ...
  en: {
    ...
    scheduleRows: [
      ...
      { type: 'fixed',       time: '12:15–13:00', activity: 'Lunch & Free Play',                  emoji: '🍽️' },
      { type: 'alternating', time: '13:00–14:00', weeks: [
    ...
    weeklySub: 'The programme is planned with different themes across 8 weeks, aiming for students to experience a different area of development each week.',
      ...
      <section className="py-16 bg-[#FAFAF8]">
        <div className="container mx-auto px-6 md:px-12 max-w-3xl">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#233256] mb-4">{d.weeklyTitle}</h2>
            <p className="text-[#4D6359] leading-relaxed">{d.weeklySub}</p>
          </motion.div>
        </div>
      </section>
